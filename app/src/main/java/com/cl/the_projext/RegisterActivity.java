    ...
    public void netSuccess(int whichApi, Object[] pD) {
        switch (whichApi) {
            ...
            case ApiConfig.REGISTER_PHONE:
                ...
                if (info.isSuccess()){
                    showToast("验证码验证成功");
                    startActivity(new Intent(this,RegisterPhoneActivity.class).putExtra(JumpConstant.JUMP_KEY,telephoneDesc.getText().toString() + userName.getText().toString().trim()));
