...
import com.cl.utils.CheckUserNameAndPwd;
        ...
        switch (whichApi) {
            ...
            case ApiConfig.COMPLETE_REGISTER_WITH_SUBJECT:
                ...
                if (base.errNo == 24 || base.errNo == 114 || base.isSuccess()) {
                    showToast("注册成功");
                    startActivity(new Intent(this, LoginActivity.class).putExtra(JumpConstant.JUMP_KEY, JumpConstant.REGISTER_TO_LOGIN));
                    finish();
